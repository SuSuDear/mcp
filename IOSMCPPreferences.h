...
#define IOS_MCP_PREFERENCES_DOMAIN @"com.susu.mcp.preferences"
#define IOS_MCP_ENABLED_PREFERENCE_KEY @"enabled"
#define IOS_MCP_DARWIN_NOTIFICATION_START CFSTR("com.susu.mcp.control/start")
#define IOS_MCP_DARWIN_NOTIFICATION_STOP CFSTR("com.susu.mcp.control/stop")
